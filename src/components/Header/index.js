...
import { Container, StyledLink, WelcomeMessage, UserAvatar, DropdownMenu, DropdownItem } from './styles'; 
import { useUser } from '../../hooks/userContext';
import User from '../../assets/user.png';
import { FaHeart, FaBell, FaGift } from 'react-icons/fa';
...
export function Header() {
  ...
  console.log('Status de autenticação:', isAuthenticated, 'Dados:', userData);
